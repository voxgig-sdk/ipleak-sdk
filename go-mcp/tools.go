...
func registerTools(server *mcp.Server, client *sdk.IpleakSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "ipleak_list",
		Description: "List records from Ipleak. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "ipleak_load",
		Description: "Load a single record from Ipleak. " +
...
func runOp(client *sdk.IpleakSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.IpleakSDK, name string) (sdk.IpleakEntity, error) {
