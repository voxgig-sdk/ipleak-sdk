...
|---|---|---|
| `ts/` | @voxgig-sdk/ipleak-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/ipleak-sdk \
      --repository voxgig-sdk/ipleak-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/ipleak-sdk` shows it, and
`npm trust revoke @voxgig-sdk/ipleak-sdk --id=<id>` removes it.
