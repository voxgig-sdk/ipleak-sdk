...
{
    private static function utility(): IpleakUtility
    {
        return new IpleakUtility();
    }
    ...
    private static function ctx(array $over = []): IpleakContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new IpleakContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new IpleakOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof IpleakError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new IpleakOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = IpleakMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new IpleakOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = IpleakMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new IpleakOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = IpleakMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new IpleakSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = IpleakMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new IpleakResponse([]),
            'result' => new IpleakResult([]),
        ]);
        [, $err] = IpleakMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new IpleakSpec(['step' => 's']),
            'response' => new IpleakResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new IpleakResult([]),
        ]);
        [, $err] = IpleakMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new IpleakSpec(['step' => 's']),
            'response' => new IpleakResponse(self::resp(200, ['v' => 1])),
            'result' => new IpleakResult([]),
        ]);
        [, $err] = IpleakMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new IpleakSpec(['step' => 's']),
            'response' => new IpleakResponse(self::resp(200, ['v' => 2])),
            'result' => new IpleakResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        IpleakMakeResponse::call($ctx);
    ...
    {
        $preset = new IpleakResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new IpleakSpec([]),
            'response' => new IpleakResponse([]),
            'result' => new IpleakResult([]),
        ...
        [$got, $err] = IpleakMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new IpleakResult([])]);
        [, $err] = IpleakMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new IpleakSpec([]), 'result' => null]);
        [, $err] = IpleakMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new IpleakSpec(['step' => 's']),
            'result' => new IpleakResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new IpleakOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = IpleakMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new IpleakSpec(['step' => 's']),
            'result' => new IpleakResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new IpleakOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = IpleakMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new IpleakResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new IpleakSpec([]),
            'result' => new IpleakResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = IpleakMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = IpleakMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new IpleakError('boom', 'boom');
        $utility->fetcher = function (IpleakContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new IpleakSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = IpleakMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (IpleakContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = IpleakMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(IpleakResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (IpleakContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new IpleakSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = IpleakMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new IpleakResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new IpleakSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = IpleakMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = IpleakMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = IpleakMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new IpleakResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, IpleakDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new IpleakResult(['ok' => false])]);
        $this->expectException(IpleakError::class);
        IpleakDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new IpleakResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', IpleakMakeError::call($ctx, null));
    }
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new IpleakBaseFeature();
        $b = new IpleakBaseFeature();
        IpleakFeatureAdd::call($ctx, $a);
        IpleakFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): IpleakBaseFeature
    {
        $f = new IpleakBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        IpleakFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): IpleakContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new IpleakSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = IpleakPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new IpleakResponse(['headers' => null]),
            'result' => new IpleakResult([]),
        ]);
        IpleakResultHeaders::call($ctx);
