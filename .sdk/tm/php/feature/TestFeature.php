...
// Ipleak SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class IpleakTestFeature extends IpleakBaseFeature
{
    ...
    public function init(IpleakContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (IpleakContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (IpleakContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(IpleakContext $ctx, $op, $args): array
    {
