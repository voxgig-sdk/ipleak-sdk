...
class IpleakRatelimitFeature extends IpleakBaseFeature
{
    ...
    private function _acquire(IpleakContext $ctx): void
    {
    ...
    private function _track(IpleakContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
