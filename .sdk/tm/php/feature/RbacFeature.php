...
class IpleakRbacFeature extends IpleakBaseFeature
{
    ...
    private function _required(IpleakContext $ctx): ?string
    {
    ...
    private function _reject(IpleakContext $ctx, string $required): void
    {
    ...
    private function _track(IpleakContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
