...
from projectname_sdk import IpleakSDK
from projectname_sdk.core.spec import IpleakSpec
from projectname_sdk.core.result import IpleakResult
from projectname_sdk.core.response import IpleakResponse
from projectname_sdk.core.operation import IpleakOperation
from projectname_sdk.core.error import IpleakError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import IpleakBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = IpleakSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = IpleakSDK.test(None, None)
        ...
        class TestInitFeature(IpleakBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(IpleakBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = IpleakSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = IpleakSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = IpleakSDK.test(None, setup_opts)
