...
class IpleakTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IpleakTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = IpleakTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = IpleakTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
