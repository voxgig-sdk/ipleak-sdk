...
class IpleakTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IpleakTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = IpleakTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = IpleakTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
