...
from projectname_sdk.core.control import IpleakControl
...
class IpleakContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, IpleakResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return IpleakError(code, msg, self)
