# Ipleak SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions IpleakSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both IpleakSDK(...) and IpleakSDK.test(...) become
#      IpleakSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "ipleak_sdk"
_SDK_CLASS = "IpleakSDK"
