...
from ipleak_sdk.utility import register

# Load features
from ipleak_sdk.feature.base_feature import IpleakBaseFeature
from ipleak_sdk.features import _has_feature, _make_feature
...
class IpleakSDK:
    ...
    def get_utility(self):
        return IpleakUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("IpleakSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def IpInformation(self, data=None) -> "IpInformationEntity":
        ...
        from ipleak_sdk.entity.ip_information_entity import IpInformationEntity
        return IpInformationEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "IpleakSDK":
        if sdkopts is None:
            sdkopts = {}
