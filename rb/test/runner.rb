...
module IpleakTestRunner
  ...
  def self.env_override(m)
    live = getenv("IPLEAK_TEST_LIVE")
    override = getenv("IPLEAK_TEST_OVERRIDE")
    ...
    explain = getenv("IPLEAK_TEST_EXPLAIN")
    m["IPLEAK_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = IpleakTestRunner
Helpers = IpleakHelpers
Vs = VoxgigStruct
