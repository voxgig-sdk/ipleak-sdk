# Ipleak PHP SDK Reference

Complete API reference for the Ipleak PHP SDK.
...
#### `IpleakSDK::test($testopts = null, $sdkopts = null)`
...
```php
$result = $client->IpInformation()->load(["ip" => "ip"]);
```
