...
// Ipleak SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = IpleakOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(IpleakOmni::structfix($now, Struct::undef()))
                        !== json_encode(IpleakOmni::structfix($val, Struct::undef()))) {
