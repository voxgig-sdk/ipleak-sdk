...
class IpleakTestRunner
{
    ...
    {
        $live = self::getenv('IPLEAK_TEST_LIVE');
        $override = self::getenv('IPLEAK_TEST_OVERRIDE');
        ...
        $explain = self::getenv('IPLEAK_TEST_EXPLAIN');
...
class_alias('IpleakTestRunner', 'Runner');
class_alias('IpleakHelpers', 'Helpers');
