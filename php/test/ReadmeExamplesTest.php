...
// Ipleak SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (IpleakSDK::test)
...
{
    private const SDK_CLASS = 'IpleakSDK';
    ...
    private const SDK_BASE = 'ipleak_sdk';
