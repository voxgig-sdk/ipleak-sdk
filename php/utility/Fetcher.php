...
class IpleakFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; IpleakSDK/1.0)';
    ...
    public static function call(IpleakContext $ctx, string $fullurl, array $fetchdef): array
    {
