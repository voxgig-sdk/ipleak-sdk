...
// Ipleak SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class IpleakMakeRequest
{
    public static function call(IpleakContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new IpleakResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new IpleakResponse($fetched);
        } else {
