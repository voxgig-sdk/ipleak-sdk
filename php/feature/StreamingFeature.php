...
class IpleakStreamingFeature extends IpleakBaseFeature
{
    ...
    private function _iterate(IpleakResult $result): \Generator
    {
    ...
    private function _streamable(IpleakContext $ctx): bool
    {
