...
class IpleakProxyFeature extends IpleakBaseFeature
{
    ...
    public function init(IpleakContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (IpleakContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
