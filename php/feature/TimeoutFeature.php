...
class IpleakTimeoutFeature extends IpleakBaseFeature
{
    ...
    private function _with_timeout(IpleakContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(IpleakContext $_ctx, float $ms): void
    {
        $client = $this->client;
