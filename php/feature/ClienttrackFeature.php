...
// Ipleak SDK clienttrack feature
...
class IpleakClienttrackFeature extends IpleakBaseFeature
{
    ...
    public function PostConstruct(IpleakContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Ipleak-SDK';
