...
class IpleakCacheFeature extends IpleakBaseFeature
{
    ...
    private function _through(IpleakContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
