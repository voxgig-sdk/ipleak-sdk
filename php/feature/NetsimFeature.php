...
class IpleakNetsimFeature extends IpleakBaseFeature
{
    ...
    private function _simulate(IpleakContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(IpleakContext $ctx, array $applied): void
    {
        $client = $this->client;
