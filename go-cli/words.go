...
func registerSDKWords(r *eng.Registry, client *sdk.IpleakSDK) {
...
func runOp(client *sdk.IpleakSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
