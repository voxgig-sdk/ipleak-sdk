...
describe("IpInformationEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set IPLEAK_TEST_IP_INFORMATION_ENTID JSON to run live")
      return
    end
...
function ip_information_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("IPLEAK_TEST_IP_INFORMATION_ENTID")
  ...
  if env["IPLEAK_TEST_LIVE"] == "TRUE" then
  ...
  local live = env["IPLEAK_TEST_LIVE"] == "TRUE"
  return {
    client = client,
    data = entity_data,
